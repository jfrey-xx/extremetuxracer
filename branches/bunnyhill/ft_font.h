...
//	Extreme Tuxracer
//
//  Copyright (C) 2001-3 Henry Maddocks (FTGL)
//	Copyright (C) 2009 ETR Team <http://www.extremetuxracer.com>
//	
//  The code from Henry Maddocks is a bit modified for
//	Extreme Tuxracer
//
// --------------------------------------------------------------------

// Hint: almost all comments are removed from the code to make it
// shorter so that alle modules can put together in a single module.
